...
public class Util {
    ...
    public static String getTime(long ms) {
        ...
        if (ms / 31449600L > 0L) {
            ...
            sb.append(String.valueOf(years)).append(" ").append(Msg.get("times.years")).append((years == 1L) ? " " : "s ");
            ms -= years * 31449600L;
        }
        if (ms / 2620800L > 0L) {
            final long months = ms / 2620800L;
            sb.append(String.valueOf(months)).append(" ").append(Msg.get("times.months")).append((months == 1L) ? " " : "es ");
            ms -= months * 2620800L;
        }
        if (ms / 604800L > 0L) {
            final long weeks = ms / 604800L;
            sb.append(String.valueOf(weeks)).append(" ").append(Msg.get("times.weeks")).append((weeks == 1L) ? " " : "s ");
            ms -= weeks * 604800L;
        }
        if (ms / 86400L > 0L) {
            final long days = ms / 86400L;
            sb.append(String.valueOf(days)).append(" ").append(Msg.get("times.days")).append((days == 1L) ? " " : "s ");
            ms -= days * 86400L;
        }
        if (ms / 3600L > 0L) {
            final long hours = ms / 3600L;
            sb.append(String.valueOf(hours)).append(" ").append(Msg.get("times.hours")).append((hours == 1L) ? " " : "s ");
            ms -= hours * 3600L;
        }
        if (ms / 60L > 0L) {
            final long minutes = ms / 60L;
            sb.append(String.valueOf(minutes)).append(" ").append(Msg.get("times.minutes")).append((minutes == 1L) ? " " : "s ");
            ms -= minutes * 60L;
        }
        if (ms > 0L) {
            sb.append(String.valueOf(ms)).append(" ").append(Msg.get("times.seconds")).append((ms == 1L) ? " " : "s ");
        }
        if (sb.length() > 1) {
    ...
    public static long getTime(final String[] args) {
        ...
        System.arraycopy(args, 2, args, 0, args.length - 2);
        args[args.length - 1] = "";
        args[args.length - 2] = "";
