        ...
        if (args.length > 0) {
            ...
            try {
                ...
                if (sender instanceof Player) {
                    ...
                    final HoverEvent ev = new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder(String.valueOf(pl.getUniqueId())).create());
            ...
            if (dupes != null) {
                for (final String dupe : dupes) {
                    ...
                    sb.append(String.valueOf(getChatColor(dupe).toString())).append(dupe).append(", ");
                }
            }
            if (sb.length() > 0) {
